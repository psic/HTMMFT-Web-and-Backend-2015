...
public class Base {
	...
	public ArrayList<Match> getMatch(String rMatch, String rTactiqueEquipe1, String rTactiqueEquipe2, String rPositions, String rPosition, String rJoueur) {
		...
		try {
			...
			if (rs_match != null) {
				while (rs_match.next()) {
					...
					Match match = CreateMatch(rs_match.getInt(1),rs_match.getInt(2),rTactiqueEquipe1,rTactiqueEquipe2, rPositions,rPosition,rJoueur);
					result.add(match);
				}
			}
		} catch (SQLException ex) {
	...
	private Match CreateMatch(int id_match, int numjournee, String rTactiqueEquipe1, String rTactiqueEquipe2, String rPositions, String rPosition, String rJoueur) {
	...
	private Joueur CreateJoueur(int id, int x, int y, String rJoueur, Equipe equipe) {
		Joueur joueur =new Joueur(id, x, y,equipe);
		if (id != 0){
